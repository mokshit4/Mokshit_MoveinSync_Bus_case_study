...
def bookings(request):
    ...
    if request.method == 'POST':
        ...
        if bus:
            if bus.nos - bus.occ >= int(seats_r):
                name_r = bus.bus_name
                source_r = bus.source
                dest_r = bus.dest
                dist_r = bus.dist
...
def cancellings(request):
    ...
    if request.method == 'POST':
        ...
        try:
            ...
            occ_r = bus.occ - book.nos
            Bus.objects.filter(id=book.busid).update(occ=occ_r)
